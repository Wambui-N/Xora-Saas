      ...
      <div className="container flex h-14 items-center max-lg:px-5">
        ...
        >
          <div className="max-xl:flex max-lg:flex-col max-lg:relative max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            ...
            <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] -translate-x-[42%] -translate-y-1/2 rotate-90">
              <Image
              ...
              />
              <Image
                className="absolute left-0 top-0 opacity-25 mix-blend-soft-light"
